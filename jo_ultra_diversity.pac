...
function FindProxyForURL(url, host) {
  ...
  // هدف: وجوه أردنية أكثر + تنويع متدرّج بدون تخريب الاستقرار
  // ======================================
  ...
  // DIRECT حصراً للرنجات السكنية الأردنية
  var RES_V4 = ["37.44.35.0/24", "37.44.45.0/24", "37.220.120.0/24", "80.90.162.0/24", "80.90.164.0/24", "82.212.67.0/24", "82.212.106.0/24", "149.200.251.0/24", "149.200.252.0/23", "149.200.254.0/24", "176.29.114.0/24", "185.96.192.0/24", "185.96.194.0/24", "188.123.176.0/24", "188.247.88.0/24", "212.34.3.0/24", "212.34.28.0/24", "212.34.31.0/24", "212.35.75.0/24", "213.139.42.0/24"]; // Zain RES
  var RES_V6 = ["2a03:b640::/32", "2a03:6b00::/29", "2a00:18d8::/29", "2a00:18d0::/32", "2a00:caa0::/32", "2001:32c0::/29", "2a00:4620::/32", "2a00:76e0::/32", "2a00:b860::/32"]; // Zain+Umniah RES
  ...
  // Weighted hashing (للتنويع الثابت داخل الإبوك)
  ...
  // اختيار حسب مزوّد الوجهة إن أمكن
  ...
  // Sticky per baseDomain داخل الإبوك
  ...
  // 1) DIRECT فقط لو الوجهة سكني أردني
  ...
  // 3) قرارات PUBG — توحيد الإيغرِس داخل الإبوك
  var line;
